...
This skill lives in `.claude\skills\` beside the other thirteen, and every one of them is readable the
...
gate. Those two plus the two environment variables are everything it changes outside this
repository. Said once each - not a paragraph of reassurance.
